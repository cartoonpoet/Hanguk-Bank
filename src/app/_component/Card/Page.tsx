...
const Card = () => {
  return <div className={styles.wrapper}>
    <header className={styles.top}>
      <div>
        ...
        <div className={styles.accountNumber}>
          123456-78-910112
          <Image src="/icon/icon-copy.svg" alt="copy" width={17} height={18} className={styles.image} />
        </div>
      </div>
      <div><Button name="설정" type="Outline" size="Small" status="Default" href="" /></div>
    </header>
    ...
    <footer className={styles.btnGroup}>
      <Button name="거래내역" type="Soft" status="Default" size="Medium" href="" />
